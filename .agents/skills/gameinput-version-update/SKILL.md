...
5. 依 NuGet 套件 README 更新 `eng/gameinput-version-notes.json` 的正體中文摘要，並確認 `docs/gameinput-version-report.md`、`docs/gameinput-redist.md` 與 `docs/gameinput-api-coverage.md` 同步更新。
