...
public sealed class GameInputDeviceManager : IDisposable
{
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentGamepad(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentKeyboard(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentMouse(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentSensors(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentController(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentArcadeStick(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentFlightStick(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentRacingWheel(device, out snapshot);
    }
    ...
    {
        ThrowIfDisposed();
        return _client.TryGetCurrentRawReport(device, out snapshot);
    }
