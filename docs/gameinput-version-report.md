...
目前基準版本：`Microsoft.GameInput` `3.5.262`

目前包裝程式庫版本：`InputWeave.GameInput v0.0.1`，NuGet / MSBuild 版本為 `0.0.1`。

- API 版本：`3`
- NuGet 套件 SHA256：`2654E45081588409F6326838E681D6B50AC533E2F24402421DD73C167744D24E`
- `native/include/GameInput.h` SHA256：`FBB769BEF01B133DBB62E3622A7137482CB52B642EA21DE080CB98279EF9610F`
- `redist/GameInputRedist.msi` SHA256：`768EFBB4D1D05FD1700EA71231D18F01E744F3960CF1AA5DD0B0899247253759`
...
Microsoft 的套件 README 以 `3.5` 系列彙整版本說明，未提供 `3.5.262` 的逐 build Changelog。以下為本專案依官方內容整理的正體中文摘要：
...
來源：[Microsoft.GameInput 3.5.262](https://www.nuget.org/packages/Microsoft.GameInput/3.5.262)
